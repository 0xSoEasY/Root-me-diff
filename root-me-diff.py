...
def get_challenges(user1, user2, target_category=None):
    ...
    rank_user1 = str(stats_user1[3])[:-5].split(" ")[-1]
    score_user1 = str(stats_user1[4])[:-5].split(" ")[-1]
    ...
    rank_user2 = str(stats_user2[3])[:-5].split(" ")[-1]
    score_user2 = str(stats_user2[4])[:-5].split(" ")[-1]
